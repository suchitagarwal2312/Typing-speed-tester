...
if __name__ == '__main__':
    prompt = "Hi, my name is Suchit Agarwal, I am from moradabad."
    print("Type this:- '", prompt, "'")

    # listening to input ENTER
    print("\n After typing sentence please press ctrl+enter")
    ...
    #to check after typing immediately press ctrl+enter.